...
import 'package:myplug_ca/features/user/presentation/ui/widgets/add_portfolio.dart';

Widget portfolioSection(BuildContext context, {required MyplugUser user}) {

void onAdd(){
  Navigator.of(context).push(MaterialPageRoute(builder: (_) => const AddPortfolioPage()));
}

    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        sectionHeader('Portfolio', onAdd),
        ...
        if (user.portfolios.isEmpty)
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _portfolioCard(portfolio);
            },
          ),
      ],
    );
  ...
  Widget _portfolioCard(Portfolio portfolio) {
    return Card(
