...
class EditableSubscriptionPlanCard extends StatefulWidget {
  final SubscriptionPlan plan;
  final Function(SubscriptionPlan updatedPlan) onSave;

  const EditableSubscriptionPlanCard({
    super.key,
    required this.plan,
  ...
  @override
  State<EditableSubscriptionPlanCard> createState() =>
      _EditableSubscriptionPlanCardState();
}

class _EditableSubscriptionPlanCardState
    extends State<EditableSubscriptionPlanCard> {
